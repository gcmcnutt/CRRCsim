...
inline uint16_t AUTOC::littleendians(uint16_t a)
{
...
inline uint16_t AUTOC::bigendians(uint16_t a)
{
  #if __BYTE_ORDER == __LITTLE_ENDIAN
  uint8_t* b = (uint8_t*)&a;
  uint8_t tmp;
...
inline uint32_t AUTOC::littleendianl(uint32_t a)
{
  #if __BYTE_ORDER == __LITTLE_ENDIAN
  return a;
  #else
...
inline uint32_t AUTOC::bigendianl(uint32_t a)
{
  #if __BYTE_ORDER == __LITTLE_ENDIAN
  uint8_t* b = (uint8_t*)&a;
  uint8_t tmp;
...
void AUTOC::put_state_data(struct imu *imudata, struct gps *gpsdata, struct servo *servopacket)
{
 ...
 ***************************************************************************************/
bool AUTOC::checksum(uint8_t* buffer, int packet_len)
{
 ...
 ***************************************************************************************/
void AUTOC::encode_gpspacket(struct gps *data, uint8_t* buffer)
{
   //signed long tmp=0;
   int tmp32;
   short i;
...
void AUTOC::encode_ahrspacket(struct imu *data, uint8_t* buffer)
{
   signed short tmp16;
...
void AUTOC::encode_servopacket(struct servo *servopacket, uint8_t* buffer)
{
   buffer[ 0] = 'F';
 ...
 ***************************************************************************************/
void AUTOC::encode_packet(struct imu *data, struct gps *gpsdata, struct servo *servopacket, uint8_t* buffer)
{
...
int AUTOC::get_servo_cmd(uint16_t cnt_cmd[3], uint8_t *reverse)
{
...
void AUTOC::decode_servo_cmd(uint8_t data[24], uint16_t cnt_cmd[3])
{
...
// display message
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
void AUTOC::display_message(struct imu *data, struct gps *gdata)
{
   //static int count=0;
