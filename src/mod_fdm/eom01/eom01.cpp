 ...
 * by Bruce Jackson.
 */
void EOM01::ls_aux(CRRCMath::Vector3 v_V_local_airmass, CRRCMath::Vector3 v_V_gust_body)
{
  ...
  /* call function for (smoothed) density ratio, sonic velocity, and ambient pressure */
